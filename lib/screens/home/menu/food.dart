              ...
              body:
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ItemSetup(FoodTypes[index].replaceAll(RegExp('_'), ' '),(){Navigator.pushNamed(context, 'Home/Food/Submenu', arguments: ['food',FoodTypes[index]]);});
                    }
                )
          );
